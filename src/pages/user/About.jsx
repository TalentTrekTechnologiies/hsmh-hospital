...
const galleryImages = [
  "https://images.unsplash.com/photo-1587351021759-3e566b6af7cc?auto=format&fit=crop&w=800&q=60",
  "https://images.unsplash.com/photo-1579154204601-01588f351e67?auto=format&fit=crop&w=800&q=60",
  "https://images.unsplash.com/photo-1581594693702-fbdc51b2763b?auto=format&fit=crop&w=800&q=60",
  ...
  <div className='w-full px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center'>
    ...
    <div className='w-full flex justify-center'>
      <img
        ...
        className='w-full max-w-md h-[300px] object-cover border border-gray-200 rounded-lg shadow-md'
      />
    </div>
      ...
      <div>
        ...
        <section className='bg-[#fdf6ec] py-16 relative'>
          ...
          <div className="relative max-w-6xl mx-auto">
            <button
              onClick={() => document.getElementById('leadSlider').scrollBy({ left: -300, behavior: 'smooth' })}
              className="absolute -left-4 top-1/2 -translate-y-1/2 bg-white shadow-md p-2 rounded-full z-10"
            >
              <ChevronLeft size={20} />
            </button>

            <div id="leadSlider" className="flex gap-6 overflow-x-auto scroll-smooth px-8 py-4 no-scrollbar">
          ...
          <div className='w-full px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center'>
            ...
            <div className='flex justify-center'>
              <img
                ...
                className='shadow-md w-full md:w-3/4 object-cover'
              />
            </div>
          </div>
        </section>
